...
const DEMO_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    body: "Amazing work! They did a fantastic job with our holiday lights. The whole neighborhood has been complimenting the display. Will definitely hire again next year.",
  ...
  },
  {
    ...
    rating: 4,
    body: "Great service, showed up on time and did quality work. Would recommend!",
    source: "platform",
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Send review requests to customers after completing their jobs.
                </p>
              </CardContent>
            </Card>
          ) : (
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge variant="outline" className="text-xs">
                      {review.source === "review_request" ? "Requested" : "Direct"}
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent>
